export default async function Page() {
	return (
		<div className="flex flex-col justify-items-center min-h-screen max-w-3xl p-20 gap-4 sm:p-20 font-[family-name:var(--font-geist-sans)]">
			...
			<div className="text-gray-300">Production Checklist</div>
			<div className="text-gray-300">
				- https://vercel.com/docs/production-checklist
			</div>
			<div className="text-gray-300">Technical Guideline for Migration</div>
			<div className="text-gray-300">
				- https://vercel.com/docs/incremental-migration/technical-guidelines
			</div>
			<div className="text-gray-300">Vercel Security Products</div>
			<div className="text-gray-300">
			...
			<div className="text-gray-300">Overview of Enterprise Offering</div>
			<div className="text-gray-300">
